...
To get a better understanding of the current BSC landscope, we divide each of the layers into the various components which we feel are most important. We then highlight some of the existing projects as well as **some potentially interesting** projects that we would like to fund by BNB Chain Accelerator Funds. If you see a component with 0 or 1 existing projects then it's likely that we would consider grant support in this area. By describing our areas of priority in detail we do not wish to preclude grant applications that address different areas that we may not have thought of. We would like to fund all projects that bring value to the ecosystem.navigate the full list.
...
| Browser Extensions | [BNB Chain Wallet](https://chrome.google.com/webstore/detail/binance-chain-wallet/fhbohimaelbohpjbbldcngcnapndodjp),[MetaMask](https://metamask.io/), [MathWallet](https://mathwallet.xyz/en/), [SafePal](https://www.safepal.io/)  
...
| Validator Dashboards | [BSCScan](https://bscscan.com/validatorset/), [BSC-Staking](https://www.bnbchain.org/en/staking)
...
|Faucet| [faucet](https://testnet.bnbchain.org/faucet-smart)
...
| Test blockchain networks | [bscnode](https://docs.bnbchain.org/docs/validator/fullnode), [Ganache](https://github.com/trufflesuite/ganache)
...
Goto [BSC Developer Ecosystem](https://github.com/bnb-chain/bsc-develop-ecosystem) to navigate the full list.
...
| File Storage, Cloud | |
| Cross Chain Bridges | [BNB Chain Bridge](https://www.bnbchain.org/en/bridge), [AnySwap](https://anyswap.exchange/dashboard), [renVM](https://renproject.io/), [NerveNetwork](https://nerve.network/), [JellySwap](https://jelly.market/), [PolyNetwork](https://www.poly.network/) | Decentralized, trustless, Open Access|
